...
options_ = [];
M_.fname = 'Aguiar_Gopinath_2007_notebook';
...
options_.order = 1;
var_list_ = {'nx';'c_y_percentage';'i_y_percentage'};
[info, oo_, options_, M_] = stoch_simul(M_, options_, oo_, var_list_);
options_.nograph = true;
options_.order = 1;
var_list_ = {'log_y';'log_c';'log_i';'g'};
[info, oo_, options_, M_] = stoch_simul(M_, options_, oo_, var_list_);
send_irfs_to_workspace;
log_Gamma_0=0; 
log_Gamma(1,1)=g_eps_g(1,1)+log_Gamma_0; 
...
%
M_.exo_det_length = 0;
M_.Sigma_e(1, 1) = (0.0048)^2;
M_.Sigma_e(2, 2) = (0.0281)^2;
options_.irf = 0;
options_.nofunctions = true;
options_.nomoments = true;
options_.order = 1;
...
save([M_.dname filesep 'Output' filesep 'Aguiar_Gopinath_2007_notebook_results.mat'], 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Aguiar_Gopinath_2007_notebook_results.mat'], 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Aguiar_Gopinath_2007_notebook_results.mat'], 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Aguiar_Gopinath_2007_notebook_results.mat'], 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Aguiar_Gopinath_2007_notebook_results.mat'], 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Aguiar_Gopinath_2007_notebook_results.mat'], 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Aguiar_Gopinath_2007_notebook_results.mat'], 'oo_recursive_', '-append');
end
if exist('options_mom_', 'var') == 1
  save([M_.dname filesep 'Output' filesep 'Aguiar_Gopinath_2007_notebook_results.mat'], 'options_mom_', '-append');
end
if ~isempty(lastwarn)
